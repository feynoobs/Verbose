 ...
 * @param my
 */
class TwitterApiStatusesUnretweet(my: Long, private val id: Long, private val db: SQLiteDatabase) : TwitterApiCommon(my, "https://api.twitter.com/1.1/statuses/unretweet/${id}.json", "POST", db)
{
    companion object
    {
        /**
