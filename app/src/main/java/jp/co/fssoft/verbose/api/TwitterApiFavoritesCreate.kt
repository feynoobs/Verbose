 ...
 *
 * @property db
 * @constructor Create empty Twitter api favorites create
 */
class TwitterApiFavoritesCreate(private val db: SQLiteDatabase) : TwitterApiCommon("https://api.twitter.com/1.1/favorites/create.json", "POST", db)
{
    companion object
    {
